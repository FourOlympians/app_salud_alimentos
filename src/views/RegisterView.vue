  ...
  <div class="auth-shell">
    ...
    <div class="auth-image">
      ...
      <div class="auth-image__overlay">
        <p class="auth-image__tagline">Tu camino hacia<br>una vida saludable</p>
      </div>
    </div>
    ...
    <div class="auth-panel">
      <div class="auth-form-wrap">
        ...
        <div v-if="success" class="success-box">
          ...
          <h2>¡Cuenta creada!</h2>
          <p>Revisa tu correo <strong>{{ email }}</strong> y confirma tu cuenta para poder iniciar sesión.</p>
          <router-link to="/login" class="btn-submit" style="text-decoration:none; display:flex; justify-content:center;">
        ...
        <template v-else>
          <header class="auth-header">
            <h1>Crear cuenta</h1>
            <p>Regístrate para acceder a recomendaciones de alimentos personalizadas.</p>
          </header>
...
.field__input-wrap input:focus { border-color: #52b788; background: rgba(82,183,136,0.08); }
...
.auth-switch a { color: #52b788; font-weight: 600; text-decoration: none; }
...
.success-box strong { color: #52b788; }
